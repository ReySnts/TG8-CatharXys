...
[CreateAssetMenu(fileName = "Idle Random Wander", menuName = "Enemy Logic/Idle Logic/RandomWander")]

public class EIRandomWander : EnemyIdleSO
{
    [SerializeField] private float RandomMoveRange = 5f;
    [SerializeField] private float RandomMoveSpeed = 1f;
    ...
    public override void DoFrameUpdateLogic()
    {
        ...
        enemy.MoveEnemy(_direction * RandomMoveSpeed);
